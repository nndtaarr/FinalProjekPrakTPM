...
import 'package:finalprojek/view/kesan_dan_pesan.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  late String nama = 'Masukan Nama';
  late String nim = 'Masukan NIM';
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((value) {
      setState(() {
        ...
        nama = value.getString('nama') ?? 'Masukan Nama';
        nim = value.getString('nim') ?? 'Masukan NIM';
      });
    });
    super.initState();
  }
